    ...
    <>
      ...
      <Card className="p-0" data-testid="profile-details-info">
        <div className="p-4" data-testid="profile-name">
          <p className="label-md text-secondary" data-testid="profile-name-label">姓名</p>
        ...
        <div className="p-4" data-testid="profile-email">
          <p className="label-md text-secondary" data-testid="profile-email-label">邮箱</p>
        ...
        <div className="p-4" data-testid="profile-phone">
          <p className="label-md text-secondary" data-testid="profile-phone-label">电话</p>
