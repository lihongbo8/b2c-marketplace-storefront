    ...
    <header data-testid="header">
      <div className="flex py-2 lg:px-8 px-4 md:px-5" data-testid="header-top">
        <div className="flex items-center lg:w-1/3">
          ...
          />
          <nav className="hidden items-center gap-4 label-md text-primary lg:flex" aria-label="岗位商城入口">
            <LocalizedClientLink href="/categories">岗位商品</LocalizedClientLink>
            <LocalizedClientLink href="/user/wishlist">我的授权</LocalizedClientLink>
          </nav>
        </div>
